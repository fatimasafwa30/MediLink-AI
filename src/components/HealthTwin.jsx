    ...
    <section className="py-24 bg-surface w-full overflow-hidden relative">
      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col items-center">
        <div className="text-center mb-16">
          <span className="font-orbitron text-accent text-sm tracking-[0.2em] uppercase font-bold">Biometric Identity</span>
          <h2 className="font-orbitron text-4xl font-bold text-text mt-2">Your Living Health Twin</h2>
          <p className="text-text-muted font-sans mt-4 max-w-xl mx-auto">A real-time digital reflection of your body's current state — always evolving, always watching.</p>
        </div>

        <div className="relative w-full max-w-4xl min-h-[600px] flex flex-col lg:flex-row items-center justify-center pt-8">
          {/* SVG Silhouette */}
          ...
          <div className="w-full lg:absolute lg:top-10 lg:left-32 glass p-4 rounded-2xl lg:animate-float mb-4 lg:mb-0 lg:max-w-xs z-10" style={{ animationDelay: '0s' }}>
            <div className="text-xs font-sans text-text-muted mb-1">Stress Index</div>
            <div className="text-text font-bold font-sans">Moderate</div>
            <div className="w-full h-2 mt-2 bg-rose-200 rounded-full overflow-hidden">
              <div className="h-full bg-gradient-to-r from-green-400 via-amber-400 to-accent" style={{ width: `${data.stress}%` }}></div>
            </div>
          </div>

          <div className="w-full lg:absolute lg:top-32 lg:right-32 glass p-4 rounded-2xl lg:animate-float mb-4 lg:mb-0 lg:max-w-xs z-10" style={{ animationDelay: '1.5s' }}>
            <div className="text-xs font-sans text-text-muted mb-1">Heart Rate</div>
            <div className="text-accent font-bold font-orbitron text-3xl">{data.heartRate} <span className="text-sm">BPM</span></div>
          ...
          <div className="w-full lg:absolute lg:top-64 lg:left-32 glass p-4 rounded-2xl flex items-center gap-4 lg:animate-float lg:max-w-xs z-10" style={{ animationDelay: '3s' }}>
            ...
            <div>
              <div className="text-xs font-sans text-text-muted">Oxygen Level</div>
        ...
        <div className="mt-8 text-center relative z-20">
          <div className="relative w-48 h-48 mx-auto flex items-center justify-center">
            <svg className="absolute inset-0 w-full h-full transform -rotate-90">
              ...
              <circle cx="96" cy="96" r="80" stroke="var(--accent)" strokeWidth="6" fill="transparent" strokeDasharray="502" strokeDashoffset={502 - (502 * data.score) / 100} className="transition-all duration-1000 ease-out" />
            ...
            <div className="flex flex-col items-center">
              <span className="font-orbitron text-5xl font-bold text-accent">{data.score}</span>
